...
public class DayWeatherBean implements Serializable {
    ...
    public List<OtherTipsBean> getOtherTipsBeanList() {
        return otherTipsBeanList;
    }

    public void setOtherTipsBeanList(List<OtherTipsBean> otherTipsBeanList) {
    ...
    public String toString() {
        return "DayWeatherBean{" +
                ...
                ", airLevel='" + airLevel + '\'' +
                ", airTips='" + airTips + '\'' +
                ", otherTipsBeanList=" + otherTipsBeanList +
                '}';
    }
}
